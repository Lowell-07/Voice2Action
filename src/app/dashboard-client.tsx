...
export default function DashboardClient() {
  ...
  return (
    <>
    <main className="flex-1 theme-shell" data-testid="page-dashboard">
      <div className="container mx-auto max-w-4xl px-6 py-16 text-center">
        ...
        <div className="mx-auto mb-12 max-w-2xl text-left">
          <Card className="theme-panel-soft rounded-xl p-2">
            ...
            <CardContent>
              <Select onValueChange={setSelectedState} value={selectedState || ""}>
                <SelectTrigger className="h-14 w-full bg-secondary/70 text-base font-medium">
        ...
        {selectedState && (
             <div>
                <div className="mb-8 flex items-center gap-3 text-left">
                    ...
                    <h2 className="text-3xl font-headline font-bold text-primary">Trending Issues in {selectedState}</h2>
                </div>
                    ...
                    {problemsInState.map((problem) => (
                        <Card key={problem.id} className="theme-panel-soft flex flex-col overflow-hidden text-left transition-all hover:-translate-y-1 hover:shadow-lg">
                            <div className="relative aspect-video w-full">
                                ...
                                />
                                <Badge className="absolute right-3 top-3" variant={problem.status === 'Resolved' ? 'default' : problem.status === 'In Progress' ? 'secondary' : 'outline'}>
                ...
                <Card className="theme-panel-soft py-16">
                    <CardHeader>
